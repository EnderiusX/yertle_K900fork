...
| ------------- | ------------- | ------------- | ------------- | ---------- |
| PLA/PETG/ABS/ABS+           | 1Kg           | £19           |    [link](https://www.aliexpress.com/item/4001291014443.html)       | Take note that PETG will be flexible and may bend under weight, ABS/ABS+ will be stiffer with still a little bit of flex and has proven well in functional print projects such as Voron/HevORT/Annex printer builds. ASA has some Ultraviolet resistance but will be stiffer than ABS. |
| SPT Servo SPT5435LV-180W 35kg | 12            | £162.36           |    [link](https://www.aliexpress.com/item/4000135787995.html)      | They need to be >= 15Kg/cm. Currently only the SPT5435LV-180LV 35kg servos (0.14s/60°) have been tested. MG995 servos have also been used but with the bare minimum of electronics, not recommended in my opinion, but seems to be able to stand up, testin gis underway by the Yertle creator for more cost-savings as majority of the cost of this project is the servo motors. If you are feeling a little richer, go for the SPT5835W-180 (0.08s/60°) which have faster turn speeds.
