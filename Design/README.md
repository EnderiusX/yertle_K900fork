...
| SPT Servo SPT5435LV-180W 35kg | 12            | £162.36           |    [link](https://www.aliexpress.com/item/1005001877857065.html)      | They need to be >= 15Kg/cm. Currently only the SPT5435LV-180LV 35kg servos (0.14s/60°) have been tested. MG995 servos have also been used but with the bare minimum of electronics, not recommended in my opinion, but seems to be able to stand up, testin gis underway by the Yertle creator for more cost-savings as majority of the cost of this project is the servo motors. If you are feeling a little richer, go for the SPT5835W-180 (0.08s/60°) which have faster turn speeds.
